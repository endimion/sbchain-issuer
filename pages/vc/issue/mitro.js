...
class IssueAmka extends React.Component {
  constructor(props) {
    ...
    this.hasRequiredAttributes =
      ...
      props.sessionData.mitro !== undefined;
  }
  ...
  static async getInitialProps({ reduxStore, req }) {
    ...
    if (typeof window === "undefined") {
      ...
      console.log(
        `mitro.js:: in the server the seal session is:: ${req.session.sealSession}`
      );
    } else {
  ...
  componentDidMount() {
    if (this.props.sessionData && this.props.sessionData.mitro) {
      let toSelect = [this.props.sessionData.mitro];
      this.props.setMitroToSelection(toSelect);
    }
  ...
  proceedWithAmkaAuth() {
    ...
    window.location.href = `${this.props.baseUrl}/mitroPoliton/mitro-authenticate${sessionFrag}`;
  }
