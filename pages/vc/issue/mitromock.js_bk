...
import ParenthoodForm from "../../../components/ParenthoodForm";
...
class IssueEbill extends React.Component {
  ...
  submit = (values) => {
    ...
    axios
      ...
      .then((response) => {
        this.props.setEBillToSession({ mitro: values });
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  render() {
    ...
    let issueVCBut = (
      <IssueVCButton
        hasRequiredAttributes={
          ...
          this.props.sessionData.mitro !== undefined
        }
        baseUrl={this.props.baseUrl}
    ...
    let result = (
      <PairOrCard
        ...
        selfForm={<ParenthoodForm onSubmit={this.submit} />}
      />
    );
