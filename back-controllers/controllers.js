...
async function onlyConnectionRequest(req, res) {
  ...
  credentials
    .createDisclosureRequest({
      ...
      callbackUrl: callback,
      vc: [
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ..8986Uci14lmK9W5obx70tEh_iDxeoDTaxOcwK-JOyjoHdVtQRgLEoipYuvoqigp6fInnbbg9Dza4myLu-pr5IQ",
      ],
      act: "none",
    })
    .then((requestToken) => {
